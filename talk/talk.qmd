...
![](./images/neurosynth_wm.png){.absolute top=0 left=15% height=80%}



##

![](./images/neurosynth_classification.png){.absolute top=0 left=15% height=30%}
...
![](./images/neurosynth_newsub.png){.absolute top=40% left=0% height=55%}


## Decoding brain activity patterns using Neurosynth

![](./images/neurosynth_multiclass.png){.absolute top=10% left=15% height=85%}
...
::: {.absolute top=90% left=0 style="font-size: 0.8em;"}
...
![](./images/neurovault_browser.png){.absolute height=80%}
:::
::::
...
![](./images/openeuro_landing.png){.absolute top=10% left=15% height=85%}
...
![](./images/bids_logo.png){.absolute top=40% left=0 height=25%}
![](./images/bids_scidata.png){.absolute top=40% left=50% height=45%}
...
![](https://www.nipreps.org/assets/nipreps-chart.png){.absolute top=10% left=15% height=85%}


## BIDS Apps

![](./images/bidsapps_title.png){.absolute top=0 left=0 height=40%}
![](./images/bidsapps_date.png){.absolute top=40% left=0%, width=50%}

:::{.absolute top=50% style='font-size: 1.2em;'}
...
![](./images/fmriprep/fmriprep.jpg){.absolute top=10% left=10% height=80%}

:::{.absolute top=80% style='font-size: 1.2em;'}
...
![](https://journals.plos.org/plosone/article/figure/image?size=large&id=10.1371/journal.pone.0184661.g005){.absolute top=10% left=20% height=80%}

:::{.absolute top=90% style='font-size: 1.2em;'}
...
![](./images/nemar/datasummary.png){.absolute top=15% left=55% height=80%}
:::
::::
